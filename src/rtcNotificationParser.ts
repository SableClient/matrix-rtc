...
export const RTC_NOTIFICATION_EVENT_TYPE: string = EventType.RTCNotification;
export const RTC_DECLINE_EVENT_TYPE: string = EventType.RTCDecline;
export const REFERENCE_REL_TYPE: string = RelationType.Reference;
